...
<div class="mini-toolbar">
    <table>
        <tr>
            <td style="width:100%;">
                <a id="remove" class="mini-button" iconCls="icon-user-delete">踢掉</a>
            </td>
...
>
    <div property="columns">
        ...
        <div field="account">SESSIONID</div>
        ...
        <div field="position" width="80">浏览器</div>
        <div field="phone" width="90">登录IP</div>
        <div field="email">登录时间</div>
        <div field="email">已在线时间</div>
    </div>
</div>
